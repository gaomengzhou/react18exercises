...
const h5Path = path.resolve(rootPath, "dist/h5.html");
const pcPath = path.resolve(rootPath, "dist/pc.html");
const appPath = path.resolve(rootPath, "build/index.template.html");

let h5 = fs.readFileSync(h5Path, opts);
let pc = fs.readFileSync(pcPath, opts);
